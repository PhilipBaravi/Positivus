...
export const serviceItemObj = [
  {
    ...
    btn: blackBtn,
    serviceImg: "./assets/magnifier.png",
    moreColor: "black",
  ...
  },
  {
    ...
    background: "darkGray",
    btn: whiteBtn,
    serviceImg: "./assets/analytics.png",
    moreColor: "white",
    decorationColor: "lightGray",
    path: "/analytics",
  },
