...
export const serviceItemObj = [
  {
    ...
    btn: blackBtn,
    serviceImg: `${import.meta.env.BASE_URL}assets/magnifier.png`,
    moreColor: "black",
  ...
  },
  {
    ...
    btn: blackBtn,
    serviceImg: `${import.meta.env.BASE_URL}assets/browser.png`,
    moreColor: "black",
  ...
  },
  {
    ...
    background: "darkGray",
    btn: whiteBtn,
    serviceImg: `${import.meta.env.BASE_URL}assets/smile.png`,
    moreColor: "white",
  ...
  },
  {
    ...
    background: "lightGray",
    btn: blackBtn,
    serviceImg: `${import.meta.env.BASE_URL}assets/email.png`,
    moreColor: "black",
    decorationColor: "neonGreen",
  ...
  },
  {
    ...
    background: "neonGreen",
    btn: blackBtn,
    serviceImg: `${import.meta.env.BASE_URL}assets/content.png`,
    moreColor: "black",
    decorationColor: "darkGray",
  ...
  },
  {
    ...
    background: "darkGray",
    btn: whiteBtn,
    serviceImg: `${import.meta.env.BASE_URL}assets/analytics.png`,
    moreColor: "white",
    decorationColor: "lightGray",
    path: "/analytics",
  },
