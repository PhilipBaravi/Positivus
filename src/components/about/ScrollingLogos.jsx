...
const companyLogos = [
  `${import.meta.env.BASE_URL}assets/amazon.png`,
  `${import.meta.env.BASE_URL}assets/dribble.png`,
  `${import.meta.env.BASE_URL}assets/hubspot.png`,
  `${import.meta.env.BASE_URL}assets/netflix.png`,
  `${import.meta.env.BASE_URL}assets/notion.png`,
  `${import.meta.env.BASE_URL}assets/zoom.png`,
];
