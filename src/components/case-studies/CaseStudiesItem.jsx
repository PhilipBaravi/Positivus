...
export default function CaseStudiesItem({ text, border }) {
  const navigate = useNavigate();

  // Function to handle navigation
  const handleNavigation = (e) => {
    e.preventDefault();
    navigate("/browser-based-services");
  };

  return (
    <div>
      <div
        className={`mt-[5%] w-[350px] 3xl:w-[411.3px] h-[252px] 3xl:h-[230px] bg-darkGray rounded-[2.8125rem] 3xl:rounded-[0]  ${border}`}
      >
        <div className="w-full p-[2.7rem] flex flex-col gap-[1.25rem]">
          <p className="text-white font-spaceGrotesk text-[1rem] font-medium font-500 leading-[1.5rem]">
            {text}
          </p>
          <div className="inline-block">
            <a
              ...
              className="font-spaceGrotesk text-[1.25rem] text-neonGreen font-medium font-500 leading-[1.75rem] mx-auto"
            >
              Learn More{" "}
              <span className="pl-[5px] inline-block mx-auto">
                <svg
